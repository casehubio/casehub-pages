...
describe("PagesTable", () => {
  ...
  describe("pagination rendering", () => {
    ...
    it("emits pages-page when next button clicked", () => {
      const ds = makeDataSet(
        [["name", "LABEL"]],
        [["A"], ["B"]],
      );
      ...
      el.addEventListener("pages-page", (e) => events.push(e as CustomEvent));
    ...
    it("emits pages-page when prev button clicked", () => {
      const ds = makeDataSet(
        [["name", "LABEL"]],
        [["C"], ["D"]],
      );
  ...
  describe("event emission (pagination)", () => {
    it("emits pages-page with correct offset on next click", () => {
      const ds = makeDataSet(
        [["name", "LABEL"]],
        [["A"], ["B"]],
      );
  ...
  describe("sorting", () => {
    it("emits pages-sort when header clicked", () => {
      const ds = makeDataSet(
        [["name", "LABEL"], ["score", "NUMBER"]],
      ...
      const events: CustomEvent[] = [];
      el.addEventListener("pages-sort", (e) => events.push(e as CustomEvent));
  ...
  describe("filtering", () => {
    it("click cell emits pages-filter with correct detail", () => {
      const ds = makeDataSet(
        [["name", "LABEL"], ["score", "NUMBER"]],
        [["Alice", 10], ["Bob", 20]],
      );
  ...
  describe("text filter", () => {
    ...
    it("typing in filter dispatches pages-text-filter event", () => {
      const ds = makeDataSet(
      ...
      const events: string[] = [];
      el.addEventListener("pages-text-filter", ((e: Event) => {
  ...
  describe("stateless sort/pagination", () => {
    it("always emits pages-sort on column header click", () => {
    ...
    it("always emits pages-page on page button click", () => {
      const ds = makeDataSet(
        [["name", "LABEL"]],
