...
export const dockWorkbenchComponentPropsSchema = z.object({
  __dockConfig: z.object({
    ...
    left: z.union([z.array(z.object({
        ...
        zones: z.union([z.number(), z.number()]).optional(),
        buttonPosition: z.enum(["start", "end"]).optional(),
    ...
    right: z.union([z.array(z.object({
          key: z.string(),
          label: z.string(),
          icon: z.string(),
          defaultOpen: z.boolean().optional(),
    ...
    bottom: z.union([z.array(z.object({
          key: z.string(),
          label: z.string(),
          icon: z.string(),
          defaultOpen: z.boolean().optional(),
...
export const barChartPropsSchema = z.object({
  ...
  barWidth: z.union([z.string(), z.number()]).optional(),
  ...
  zoom: z.union([z.boolean(), z.boolean(), z.object({
      enabled: z.boolean().optional(),
  ...
  legend: z.object({
    ...
    selectedMode: z.union([z.boolean(), z.boolean(), z.string(), z.string()]).optional(),
  }).optional(),
  margin: z.object({
  ...
  echarts: z.object({
    ...
    dataZoom: z.array(z.object({
        ...
        filterMode: z.enum(["filter", "none", "weakFilter", "empty"]).optional(),
...
export const lineChartPropsSchema = z.object({
  ...
  step: z.union([z.boolean(), z.string(), z.string(), z.string()]).optional(),
...
export const pieChartPropsSchema = z.object({
  ...
  roseType: z.enum(["area", "radius"]).optional(),
...
export const heatmapChartPropsSchema = z.object({
  ...
  blurSize: z.number().optional(),
  minOpacity: z.number().optional(),
  maxOpacity: z.number().optional(),
  title: z.string().optional(),
  visible: z.boolean().optional(),
  width: z.string().optional(),
  height: z.string().optional(),
...
export const treemapChartPropsSchema = z.object({
  ...
  sort: z.union([z.boolean(), z.boolean(), z.string(), z.string()]).optional(),
  leafDepth: z.number().optional(),
  nodeClick: z.union([z.boolean(), z.string(), z.string()]).optional(),
  title: z.string().optional(),
  visible: z.boolean().optional(),
  width: z.string().optional(),
  height: z.string().optional(),
...
export const selectorPropsSchema = z.object({
  subtype: z.enum(["slider", "dropdown", "labels"]).optional(),
  title: z.string().optional(),
  visible: z.boolean().optional(),
  width: z.string().optional(),
  height: z.string().optional(),
...
export const mapPropsSchema = z.object({
  ...
  roam: z.union([z.boolean(), z.boolean(), z.string(), z.string()]).optional(),
  center: z.object({
    "__@unscopables@99": z.object({}),
  }).optional(),
...
export const graphCanvasPropsSchema = z.object({
  sourceColumn: z.string().optional(),
  targetColumn: z.string().optional(),
  nodeLabelColumn: z.string().optional(),
  nodeColorColumn: z.string().optional(),
  ...
  valueColumn: z.string().optional(),
  directed: z.boolean().optional(),
  direction: z.enum(["DOWN", "RIGHT", "LEFT", "UP"]).optional(),
  spacing: z.number().optional(),
  algorithm: z.enum(["force", "layered", "tree", "radial", "stress"]).optional(),
  ...
  reactFlow: z.object({
    ...
    defaultMarkerColor: z.string().optional(),
    selectionMode: z.enum(["full", "partial"]).optional(),
    elementsSelectable: z.boolean().optional(),
  }).optional(),
  elk: z.object({
...
export const componentSchemaMap: ReadonlyMap<string, z.ZodType> = new Map([
  ...
  ["dock-workbench", dockWorkbenchComponentPropsSchema],
