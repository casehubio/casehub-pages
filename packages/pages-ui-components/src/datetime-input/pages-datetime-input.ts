...
export class PagesDatetimeInput extends LitElement {
...
if (!customElements.get('pages-datetime-input')) {
  customElements.define('pages-datetime-input', PagesDatetimeInput);
}
