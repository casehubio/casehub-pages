...
export class PagesNumberInput extends LitElement {
    ...
    return html`
      <div class="field">
        ...
        <input
          ...
          min=${ifDefined(this.min != null ? String(this.min) : undefined)}
          max=${ifDefined(this.max != null ? String(this.max) : undefined)}
          step=${ifDefined(this.step != null ? String(this.step) : undefined)}
