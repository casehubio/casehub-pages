...
class DataResourceRelayTest {
    ...
    void fetch_without_jwt_returns_401() {
        given()
                ...
                .body(new DataRequest("https://example.com/data", "GET", null, null, null, null, null))
                .when()
    ...
    void fetch_non_http_url_returns_400() {
        given()
                ...
                .contentType(ContentType.JSON)
                .body(new DataRequest("file:///etc/passwd", "GET", null, null, null, null, null))
                .when()
                .post("/api/dataset/fetch")
                .then()
                .statusCode(400);
    ...
    void fetch_loopback_address_returns_403() {
        given()
                .auth().oauth2(createValidToken())
                .contentType(ContentType.JSON)
                .body(new DataRequest("http://127.0.0.1/test", "GET", null, null, null, null, null))
                .when()
                .post("/api/dataset/fetch")
                .then()
                .statusCode(403);
    ...
    void fetch_ftp_scheme_returns_400() {
        given()
                .auth().oauth2(createValidToken())
                .contentType(ContentType.JSON)
                .body(new DataRequest("ftp://example.com/data", "GET", null, null, null, null, null))
                .when()
                .post("/api/dataset/fetch")
                .then()
                .statusCode(400);
    ...
    void fetch_localhost_returns_403() {
        given()
                .auth().oauth2(createValidToken())
                .contentType(ContentType.JSON)
                .body(new DataRequest("http://localhost/test", "GET", null, null, null, null, null))
                .when()
                .post("/api/dataset/fetch")
                .then()
                .statusCode(403);
